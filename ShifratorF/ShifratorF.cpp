...
// ShifratorF.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CShifratorFApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CShifratorFApp

CShifratorFApp::CShifratorFApp()
{
...
// Единственный объект CShifratorFApp

CShifratorFApp theApp;


// инициализация CShifratorFApp

BOOL CShifratorFApp::InitInstance()
{
